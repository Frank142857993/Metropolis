...
public class ChunkGenSettings {
    ...
    public static class Factory
    {
        ...
        public int dirtSize = 0;
        public int dirtCount = 0;
        public int dirtMinHeight;
        public int dirtMaxHeight = 0;
        public int gravelSize = 0;
        public int gravelCount = 0;
        public int gravelMinHeight;
        public int gravelMaxHeight = 0;
        public int graniteSize = 0;
        public int graniteCount = 0;
        public int graniteMinHeight;
        public int graniteMaxHeight = 0;
        public int dioriteSize = 0;
        public int dioriteCount = 0;
        public int dioriteMinHeight;
        public int dioriteMaxHeight = 0;
        public int andesiteSize = 0;
        public int andesiteCount = 0;
        public int andesiteMinHeight;
        public int andesiteMaxHeight = 0;
        public int coalSize = 0;
        public int coalCount = 0;
        public int coalMinHeight;
        public int coalMaxHeight = 0;
        ...
        public void setDefaults()
        {
            ...
            this.dirtMaxHeight = 0;
            this.gravelSize = 0;
            this.gravelCount = 0;
            this.gravelMinHeight = 0;
            this.gravelMaxHeight = 0;
            this.graniteSize = 0;
            this.graniteCount = 0;
            this.graniteMinHeight = 0;
            this.graniteMaxHeight = 0;
            this.dioriteSize = 0;
            this.dioriteCount = 0;
            this.dioriteMinHeight = 0;
            this.dioriteMaxHeight = 0;
            this.andesiteSize = 0;
            this.andesiteCount = 0;
            this.andesiteMinHeight = 0;
            this.andesiteMaxHeight = 0;
            this.coalSize = 0;
            this.coalCount = 0;
            this.coalMinHeight = 0;
            this.coalMaxHeight = 0;
            this.ironSize = 9;
            this.ironCount = 20;
