...
public class BiomeProviderMetropolis extends BiomeProvider {

    private GenLayer genBiomes;
    private GenLayer biomeIndexLayer;
    private BiomeCache biomeCache;

    public BiomeProviderMetropolis()
    {
        this.biomeCache = new BiomeCache(this);
    }

    public BiomeProviderMetropolis(long seed)
    {
        this();
        GenLayer[] agenlayer = GenLayerFixMetropolis.createWorld(seed);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public BiomeProviderMetropolis(World world)
    {
        this(world.getSeed());
    }
