...
public class BlockMtrPortal extends BlockBreakable implements IHasModel {
    ...
    public boolean trySpawnPortal(World world, BlockPos pos) {
        ...
        if(ConfigHandler.ENABLE_PORTAL){
    ...
    public static class Size {
        ...
        protected boolean isEmptyBlock(Block block) {
            return block.getDefaultState().getMaterial() == Material.AIR || block == Blocks.FIRE || block == BlockInit.BLOCK_CRUDE || block == BlockInit.BLOCK_MTR_PORTAL;
        }
