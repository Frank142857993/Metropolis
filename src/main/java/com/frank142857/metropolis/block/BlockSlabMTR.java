...
public abstract class BlockSlabMTR extends BlockSlab {
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune){
        ...
        else if (this == BlockInit.POLISHED_FOUNDATION_STONE_SLAB_DOUBLE || this == BlockInit.POLISHED_FOUNDATION_STONE_SLAB_HALF) return Item.getItemFromBlock(BlockInit.POLISHED_FOUNDATION_STONE_SLAB_HALF);
        else if (this == BlockInit.BLACK_BRICK_SLAB_DOUBLE || this == BlockInit.BLACK_BRICK_SLAB_HALF) return Item.getItemFromBlock(BlockInit.BLACK_BRICK_SLAB_HALF);
